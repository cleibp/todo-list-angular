<h1 align="center"> 🚀 TODO LIST | ANGULAR </h1>

## ✍️ Descrição
Exemplificação de TODO LIST usando framework js angular
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/todo-list-angular.git
    ```
1. Download:
    ### Download Manual
...
[Publicação em Codepen](https://codepen.io/cleibp/pen/mdapVOr) 
